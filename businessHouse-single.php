                                            ...
                                            <div class="dropdown dropdown-lg">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="checkbox">
                                                            <label><input type="checkbox">Find Your Business Space</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">More Details About Business spaces</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
        							...
        							<div class="form-bg seven">
        								<div class="form-content">
        									...
        									<div class="form-group">
                                                ...
                                                <input type="tel" name="phonenumber" pattern="[+254][0-9]{12}" required placeholder="+251" autocomplete="off"><br>
