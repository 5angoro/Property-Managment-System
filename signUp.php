...
<center><h5><b> <a style="color:orange" href="agreementHouseRental.php?agree=agreement">Read more </a></b></h5></center>
        ...
        <form class="form-right" method="post" enctype="multipart/form-data">
			...
			<h4 ><span><?php echo $message; ?></span></h4>
               ...
               <div class="mb-3">
                    <label>Phone</label>
                    <input type="text" pattern="[+254]+[0-9]{12}" value="<?php echo $phone;?>" autocomplete="off" title="Please enter valid phone number" name="phone" id="phone" required class="input-field">
                </div> 
       <br>
            <div class="mb-3">
