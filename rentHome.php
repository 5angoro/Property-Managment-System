                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group">
                                  ...
                                  <select name="sel" style="height:40px;font-size:18px" class="selectpicker form-control">
                                    <option style="height:40px;font-size:18px">Apartements</option>
									<option style="height:40px;font-size:18px">Condominium</option>
									<option style="height:40px;font-size:18px">Real Estate</option>
									<option style="height:40px;font-size:18px">Family Home</option>
									<option style="height:40px;font-size:18px">Single room house</option>
									<option style="height:40px;font-size:18px">Business Spaces</option> </select>
                                </div>
                            </div>
                         </div>
