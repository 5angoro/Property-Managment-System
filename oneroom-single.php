                                            ...
                                            <div class="dropdown dropdown-lg">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="checkbox">
                                                            <label><input type="checkbox">Find Your Single Room House</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">More Details About single room house</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
        						...
        						<form method="post" enctype="multipart/form-data" class="advance_search_query booking-form">
        							<div class="form-bg seven">
        								<div class="form-content">
                                            <h2 class="form-title">Book This single room House</h2>
        									...
        									<div class="form-group">
                                                ...
                                                <input type="tel" name="phonenumber" pattern="[+254][0-9]{12}" required placeholder="+254" autocomplete="off"><br>
											  
        									</div><!-- /.form-group -->
        									<div class="form-group">
        										<label>Email Address</label>
        										<input type="email" name="email" required placeholder="propertyhub@gmail.com" autocomplete="off"><br>
