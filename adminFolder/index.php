...
<head>
	...
	<title>Admin PropertyHub Management System</title>
...
<body>
	<div style="padding:20px;"class="wrapper">
			...
			<div style="margin-top:10px;border-radius:10px;background-color:transparent " class="main-panel">
				<div style="border-radius:10px; padding:10px;"class="content">
					<div  class="container-fluid">
						
						<div style="background-color:transparent ; padding:10px;" class="row">
							<div class="col-md-3">
...
$row=mysqli_num_rows($sql);?>
												<div class="numbers">
													<p class="card-category"><a style="text-decoration:none;color:white" href="availableNormalhouse.php">Available Family Home</a></p>
...
$row=mysqli_num_rows($sql);?>
												<div class="numbers">
													<p class="card-category"><a style="text-decoration:none;color:white" href="availableOneroomhouse.php">Available Single room house</a></p>
...
$row=mysqli_num_rows($sql);?>
												<div class="numbers">
													<p class="card-category"><a style="text-decoration:none;color:white" href="availableBusinesshouse.php">Available Business Spaces</a></p>
...
$row=mysqli_num_rows($sql);?>
						...
						<div style="width:100%; border-radius:30px " class="row row-card-no-pd">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
...
$row=mysqli_num_rows($sql);?>
											<div class="d-flex justify-content-between mb-1">
												<span class="text-muted">Booked homes</span>
												<span class="text-muted fw-bold"><?php echo $row; ?></span>
											</div>
											<div class="progress mb-2" style="height: 7px;">
...
$row=mysqli_num_rows($sql);?>
										<div class="progress-card">
											<div class="d-flex justify-content-between mb-1">
												<span class="text-muted">Rented homes</span>
												<span class="text-muted fw-bold"><?php echo $row; ?></span>
											</div>
											<div class="progress mb-2" style="height: 7px;">
...
$row=mysqli_num_rows($sql);?>
										...
										<div class="progress-card">
											<div class="d-flex justify-content-between mb-1">
												<span class="text-muted">Total Number of Houses</span>
												<span class="text-muted fw-bold"><?php echo $row; ?></span>
											</div>
											<div class="progress mb-2" style="height: 7px;">
