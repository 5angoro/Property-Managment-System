...
if(isset($_POST['reply'])){
	...
	$messag=mysqli_real_escape_string($conn,$_POST['message']);
                ...
                $message = $messag;
                $sender = "From: sangoroalan@gmail.com";
								...
								<tr>
									...
									<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											    ...
											    <a class="dropdown-item" data-toggle="modal" type="button" data-target="#_modal<?php echo $row['id'] ?>"><p style="color: royalblue;"><i class="fas fa-reply"></i> </p></a>
...
<div style="margin-left:250px" class="modal fade bs-example-modal-xl" id="reply_modal<?php echo $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-xl modal-dialog-centered">
				...
				<div style="width:100%"class="col-md-20">
					...
					<div class="pull-center">
						<center><h4><p class="mb-60">Reply to User</p></h4></center>
						</div>
							<div class="row">
