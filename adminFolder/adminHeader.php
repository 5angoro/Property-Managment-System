...
<body   style="background-color:#002525">
<div class="main-header">
			<div class="logo-header">
				<a href="index.php" class="logo">
					<img style="width: 50px;height:50px;background-color:transparent vertical-align: middle; " src="../assets/images/footer-logo.png" alt="House Rent Logo"/>
				</a>
			</div>
    ...
    { ?>	
			...
			<div style="background-color:#002525 " class="sidebar">
			<br><br>
					...
					<ul class="nav">
						...
						<li class="nav-item">
								...
								<ul class="dropdown">
									...
									<a class="dropdown-item" href="contact.php"><i class="la la-comment"></i><p>Reply Contact</p></a>
