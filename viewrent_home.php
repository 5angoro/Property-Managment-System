                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group">
                                ...
                                <select name="sel" readonly style="border-top-style: hidden;border-right-style: hidden;border-left-style: hidden;border-bottom-style: hidden;background-color:transparent;"  class="selectpicker form-control">
                                    <option value="Apartement" <?php if($row['category']=="Apartement"){echo"selected";} ?>>Apartements</option>
									...
									<option value="Normal House" <?php if($row['category']=="Normal House"){echo"selected";} ?>>Family Home</option>
									<option value="One room house" <?php if($row['category']=="One room house"){echo"selected";} ?>>Singgle room house</option>
									<option value="Business house" <?php if($row['category']=="Business house"){echo"selected";} ?>>Business Spaces</option> 
								</select>
                                </div>
                            </div>
                         </div>
