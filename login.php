...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>PropertyHub Management System</title>
...
<body style="background-color:#002525 " class="login-page">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login PropertyHub Management System</h2>
						</div>
						<div >
