...
<head>
    ...
    <!-- Titles
    ================================================== -->
    <title>PropertyHub Managment System</title>
    ...
    <!-- ====== Header Top Area ====== -->
    <header style="background-color:#003535" class="header-area nevy-blue-bg hidden-xs hidden-sm">
        <div class="container">
            <div class="header-top-content">
              ...
              <div class="col-md-5 col-sm-5 mobile-center">
				...
				if(strlen(isset($_SESSION['alogin']))==0){
					...
					?>
				   <li>
                          <a href="tel:+254743690110"><i class="fa fa-phone-square"></i>Call Us <?php echo $phone;?></a>
                           </li>
   ...
   <?php } ?>
    ...
    <header style="background-color:#003535" class="header-bottom-content nevy-blue-bg hidden-xs hidden-sm">
        <div class="container">        
            <div class="row">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
											 ...
											 <li>
                                                <a href="oneRoom.php">Single room house</a>
                                            </li>
											 <li>
                                                <a href="normalHouse.php">Family Home</a>
                                            </li>
											 <li>
                                                <a href="businessHouse.php">Business Spaces</a>
                                            </li>
                                        </ul>
                                    </li>
